...
def make_retail_tools(env: RetailEnv, allowed_tools: list[str] | None = None) -> list[StructuredTool]:
...
def invoke_retail_tool(tools: list[StructuredTool], name: str, arguments: dict[str, Any]) -> dict[str, Any]:
